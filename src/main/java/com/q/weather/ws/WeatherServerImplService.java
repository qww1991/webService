 ...
 * 
 */
@WebServiceClient(name = "WeatherServerImplService", targetNamespace = "http://ws.weather.q.com/", wsdlLocation = "http://localhost:8090/weather/ws/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVERIMPLSERVICE_QNAME = new QName("http://ws.weather.q.com/", "WeatherServerImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/weather/ws/weather?wsdl");
     ...
     * 
     * @return
     *     returns WeatherServer
     */
    @WebEndpoint(name = "WeatherServerImplPort")
    public WeatherServer getWeatherServerImplPort() {
        return super.getPort(new QName("http://ws.weather.q.com/", "WeatherServerImplPort"), WeatherServer.class);
    }
     ...
     */
    @WebEndpoint(name = "WeatherServerImplPort")
    public WeatherServer getWeatherServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.weather.q.com/", "WeatherServerImplPort"), WeatherServer.class, features);
    }
